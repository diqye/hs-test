-- stack --resolver lts-16.9 runghc --package process --package mtl --package http-client --package http-client-tls --package bytestring --package connection --package data-default-class --package parsec --package string-conversions --package aeson
...
main = do
  ...
  last <- newMVar "../../info/1519/21916.htm"
...
sendMeTime = sendMe "CIDMoo8GEiJBRFhRVE5JNzVRWEFFWEJISTNTRDRNVUpRQlBQWFpZUkVJIgQIARAC.Lu6PPILT0dOsZ8UUPwAs-81ONN0MFbmzMMapw3hsIAk"
